...
@Component({
  selector: 'app-relief-relief-status',
  templateUrl: './relief-relief-status.component.html',
  styleUrl: './relief-relief-status.component.scss'
})
export class ReliefReliefStatusComponent {
  ...
  ngOnInit(): void {
    this.subscription.add(
      this.csr.reliefStatus$.subscribe((res: any) => {
        if(res){
