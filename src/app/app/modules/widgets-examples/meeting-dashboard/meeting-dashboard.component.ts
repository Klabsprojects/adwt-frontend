...
export class MeetingDashboardComponent {
  ...
  headerCards = [
    { title: 'Total No of Districts Meeting', value: 0 },
    { title: 'Total Meeting couducted Q1', value: 0 },
    { title: 'Total Meeting conducted Q2', value: 0 },
    { title: 'Total Meeting conducted Q3', value: 0 },
    { title: 'Total Meeting conducted Q4', value: 0 },
  ];

  headerCards2 = [
    { title: 'Total No of Sub Division Meeting', value: 0 },
    { title: 'Total Meeting couducted Q1', value: 0 },
    { title: 'Total Meeting couducted Q2', value: 0 },
    { title: 'Total Meeting couducted Q3', value: 0 },
    { title: 'Total Meeting couducted Q4', value: 0 },
  ];

  headerCards3 = [
    { title: 'Financial Year', value: 'ALL' },
    { title: '1st Meeting', value: 'Completed' },
    { title: '2nd Meeting', value: 'Pending' },
  ];
