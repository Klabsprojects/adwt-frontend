...
@Component({
  ...
  templateUrl: './before-abstract.component.html',
  styleUrl: './before-abstract.component.scss'
})
export class BeforeAbstractComponent {
